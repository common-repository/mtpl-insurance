...
//register_activation_hook( __FILE__, 'activate_mtpl_insurance' );
//register_deactivation_hook( __FILE__, 'deactivate_mtpl_insurance' );
 ...
 * @since    1.0.0
 */
function run_mtpl_insurance() {

	$plugin = new Mtpl_Insurance();
	$plugin->run();
