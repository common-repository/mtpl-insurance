...
class Mtpl_Insurance {
	...
	private function load_dependencies() {
		...
		$this->loader = new Mtpl_Insurance_Loader();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Mtpl_Insurance_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Mtpl_Insurance_Loader    Orchestrates the hooks of the plugin.
	 */
